...
const NotFound: FC = () => {
  ...
  // --- Render Logic ---
  return (
    <div className="flex h-screen items-center justify-center overflow-hidden bg-zinc-50 dark:bg-zinc-900">
      <div className="p-8 text-center">
        ...
        <motion.h1
          ...
          className="mb-4 text-8xl font-extrabold text-zinc-800 dark:text-zinc-200 drop-shadow-lg"
        >
          404
        </motion.h1>
        ...
        <motion.p
          ...
          className="mb-8 font-medium text-zinc-600 dark:text-zinc-400"
        >
          {countdown > 0
        ...
        >
          <Link
            to="/"
            className="rounded-full bg-zinc-900 dark:bg-zinc-100 px-8 py-3 font-semibold text-white dark:text-zinc-900 shadow-lg transition hover:bg-zinc-800 dark:hover:bg-zinc-200 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2"
          >
            {t('notFound.goHome')}
          </Link>
        </motion.div>
