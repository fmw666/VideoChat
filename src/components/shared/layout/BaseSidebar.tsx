    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="fixed top-0 left-0 h-14 z-40 md:hidden flex items-center px-4">
        ...
        >
          ...
          />
          {/* 悬停时的光晕效果 */}
          <span className="absolute inset-0 rounded-lg bg-zinc-100/0 group-hover:bg-zinc-100/50 dark:group-hover:bg-zinc-500/10 transition-colors duration-200" />
        </button>
      </div>
      {/* 移动端侧边栏遮罩层 */}
      <Transition
      ...
      <Transition
        ...
        className={isMobileWidth ? 'fixed inset-y-0 left-0 z-50' : 'relative'}
      >
        <div
